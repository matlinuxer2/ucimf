...
fetch_googlecode_file libucimf-2.2.9.1.tar.gz
fetch_googlecode_file ucimf-openvanilla-2.10.6.tar.gz
fetch_googlecode_file openvanilla-modules-0.8.0_14.tar.gz
fetch_googlecode_file fbterm_ucimf-0.2.6.tar.gz
...
debbing libucimf-2.2.9.1.tar.gz debian-libucimf/debian $TEMP_DIR 
debbing ucimf-openvanilla-2.10.6.tar.gz debian-ucimf-openvanilla/debian $TEMP_DIR 
debbing openvanilla-modules-0.8.0_14.tar.gz debian-openvanilla-modules/debian $TEMP_DIR 
debbing fbterm_ucimf-0.2.6.tar.gz debian-fbterm-ucimf/debian $TEMP_DIR 
